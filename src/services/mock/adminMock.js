...
export async function getAdminDashboard() {
  ...
  return {
    ...
    recentConversations: [
      ...
      { id: 'c-002', title: '튜닝 기출 오답노트', mode: 'study', updatedAt: Date.now() - 1000 * 60 * 32 },
      ...
      { id: 'c-005', title: '정규화 핵심 요약', mode: 'study', updatedAt: Date.now() - 1000 * 60 * 60 * 12 },
      ...
      { id: 'c-008', title: '데이터 표준화 핵심 정리', mode: 'study', updatedAt: Date.now() - 1000 * 60 * 60 * 72 },
    ],
