 ...
 *
 * StudySubTabs 좌측에 배치되어 활성 과목(SQLP / DAP / 정보관리기술사 / 사용자정의)을
 * 전환한다. 과목별 오답노트·체크리스트·통계·현재 퀴즈 세션이 `subjects[id]` 버킷에
 * 격리돼 있으므로, 이 컴포넌트에서 activeSubject만 바꿔도 각 패널 구독이 즉시 교체된다.
 *
